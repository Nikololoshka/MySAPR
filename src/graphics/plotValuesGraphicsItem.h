...
public:
    ...
    */
    ...
    /*!
     Устанавливает параметр отображения значений на эпюрах.
    */
    void setDisplyValues(bool displyValues);
...
private:
    ...
    bool displyValues_; /*!< Отвечает за отображение значений на эпюрах. */
